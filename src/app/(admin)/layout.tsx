...
const menuItems: MenuItem[] = [
  ...
  { name: "Users", icon: Users, href: "/admin/users" },
  {
    ...
    href: "#",
    subItems: [
      { name: "Add Board", icon: Layers, href: "/admin/dashboard/boards" },
      { name: "Add Class", icon: BookOpen, href: "/admin/dashboard/classes" },
      { name: "Add Subject", icon: Bookmark, href: "/admin/dashboard/subjects" },
      { name: "Add Chapter", icon: FileText, href: "/admin/dashboard/chapters" },
    ],
  },
